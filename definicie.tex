...
\emph{Distribúcia stupňov vrcholov} grafu $G$ je stacionárna funkcia \todo{pozri slovenský ekvivalent}
$p(d)$ reprezentujúca pravdepodobnosť toho, že vrchol má stupeň $d$. Platí, že: 
$$p(d) = \frac{\sum_{v \in V}^{}{\delta(d - d_v)}}{|V|}$$\todo{vysvetli, čo to znamená..}
...
grafu} $G$ je stacionárna funkcia $c(d)$, ktorá hovorí o tom, aký je priemer
klasterizačných koeficientov pre všetky vrcholy stupňa $d$. Vypočítame ho ako: 
$$c(d) = \frac{\sum_{v \in V}^{}{\delta(d - d_v)c_v}}{d}$$
